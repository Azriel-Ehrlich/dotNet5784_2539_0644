...
internal class TaskImplementation : BlApi.ITask
{
	...
	void checkTask(BO.Task task)
	{
		...
		if (task.Engineer is not null)
		{
			...
			DO.Engineer eng = _dal.Engineer.Read(task.Engineer.Id) ?? throw new BO.BlInvalidParameterException("The Engineer assigned to the task doesn't exist");
		}
	}
